    ...
    >
      ...
      {buttons.map((button, index) => (
        <button
          ...
          className="relative z-10 flex items-center justify-center gap-2 rounded-full px-2 py-1 transition-colors cursor-pointer"
        >
          {button.isLogo ? (
            ...
            <span
              className={`text-center font-normal font-sans text-sm leading-tight transition-colors ${
                activeButton === button.id
                  ? "text-white [text-shadow:_0px_1px_0px_rgb(255_255_255_/_0.65)] dark:text-white/80"
